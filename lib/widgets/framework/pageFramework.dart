      ...
      body: widget.bodyBuilder != null
          ...
          : Stack(
              children: [
                ...
                if (widget.overlay != null) widget.overlay ?? const SizedBox.shrink(),
              ],
            ),
    );
    ...
    Widget appBar = SliverAppBar(
      ...
      flexibleSpace: LayoutBuilder(
        ...
        return FlexibleSpaceBar(
          ...
          titlePadding:
              const EdgeInsetsDirectional.symmetric(vertical: 15, horizontal: 18),
          title: MediaQuery(
  ...
  return [
    ...
    centeredTitleSmall && appBarBackgroundColorStart == null
        ...
        : Container(
            ...
            color: appBarBackgroundColorStart ?? Theme.of(context).colorScheme.surface,
          ),
