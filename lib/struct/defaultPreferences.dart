...
Future<Map<String, dynamic>> getDefaultPreferences() async {
  return {
    ...
    "autoInsertNotificationsDirectly": true,
    "persistentBackgroundListener": true,
    "showWalletSwitcher": false,
    "showWalletSwitcherFullScreen": false,
    "showWalletList": true,
    "showWalletListFullScreen": true,
    "walletsListCurrencyBreakdown": false,
    "walletsListGroupByColor": false,
    "walletsListGroupStyle": "Account Type",
    "showPinnedBudgets": false,
    "showPinnedBudgetsFullScreen": false,
    "showObjectives": false,
    "showObjectivesFullScreen": false,
    "showAllSpendingSummary": true,
    "showAllSpendingSummaryFullScreen": true,
    "showNetWorth": false,
    "showNetWorthFullScreen": false,
    "showOverdueUpcoming": true,
    "showOverdueUpcomingFullScreen": true,
    "showObjectiveLoans": false,
    "showObjectiveLoansFullScreen": false,
    "showCreditDebt": true,
    ...
    "numberPadHapticFeedback": true,
    "savingHapticFeedback": true,
    "closeNavigationHapticFeedback": true,
    "tabNavigationHapticFeedback": true,
    "buttonPressHapticFeedback": true,
    "deleteActionHapticFeedback": true,
